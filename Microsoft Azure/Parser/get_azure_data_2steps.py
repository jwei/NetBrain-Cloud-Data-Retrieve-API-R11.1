...
It sends a POST request which returns a table URL in the HTTP response location header.
It sends a subsequent GET request to get the table data from the returned URL.
